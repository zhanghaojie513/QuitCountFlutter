...
- 严格复刻原型手机端页面：`01-home`、`02-home-info-modal`、`03-take-sheet`、`04-assets`、`05-add-asset-modal`、`05-add-asset-errors`、`06-ledger`、`07-ledger-info-modal`、`08-model`、`09-mine`、`13-goal-modal`、`14-help-modal`、`16-settings`、`18-daily-review-modal`、`19-login`、`20-mine-synced`、`21-login-synced`。
